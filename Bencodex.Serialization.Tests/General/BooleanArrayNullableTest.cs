...
public class BooleanArrayNullableTest
{
    public static object?[][] TestData =>
    [
        [nameof(FieldClass.Boolean), RandomUtility.NullableArray(RandomUtility.Boolean)],
    ];
    ...
    {
        [Bencode]
        public bool?[] Boolean = RandomUtility.NullableArray(RandomUtility.Boolean);
    }

    public sealed class PropertyClass
    {
        [Bencode]
        public bool?[] Boolean { get; set; } = RandomUtility.NullableArray(RandomUtility.Boolean);
    }
}
