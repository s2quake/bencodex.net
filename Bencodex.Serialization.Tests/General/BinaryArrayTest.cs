...
public class BinaryArrayTest
{
    ...
    [
        [
            ...
            RandomUtility.Array(() => RandomUtility.Array(RandomUtility.Byte)),
        ],
        [
            nameof(FieldClass.ImmutableArray),
            RandomUtility.Array(() => RandomUtility.ImmutableArray(RandomUtility.Byte)),
        ],
        [
            nameof(FieldClass.ImmutableList),
            RandomUtility.Array(() => RandomUtility.ImmutableList(RandomUtility.Byte)),
        ],
        [
            nameof(FieldClass.List),
            RandomUtility.Array(() => RandomUtility.List(RandomUtility.Byte)),
        ],
    ];
