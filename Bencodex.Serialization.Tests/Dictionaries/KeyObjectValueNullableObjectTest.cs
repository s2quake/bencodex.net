...
public class KeyObjectValueNullableObjectTest
{
    private static readonly RandomUtility.DictionarySettings<object, object?> Settings
        = new() { IsNullable = true };

    public static IEnumerable<object[]> TestData =>
    [
        [nameof(FieldClass.Dictionary), RandomUtility.Dictionary<object, object?>(Settings)],
        [nameof(FieldClass.ImmtableDictionary), RandomUtility.ImmutableDictionary<object, object?>(Settings)],
    ];
    ...
    public sealed class FieldClass
    {
        ...
        public Dictionary<object, object?> Dictionary
            = RandomUtility.Dictionary(Settings);

        [Bencode]
        public ImmutableDictionary<object, object?> ImmtableDictionary
            = RandomUtility.ImmutableDictionary(Settings);
    }
